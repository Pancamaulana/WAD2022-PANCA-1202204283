...
include 'config/connector.php';
  ...
  if (isset($_GET['id_mobil'])) {
    ...
    $query = "SELECT * FROM showroom_panca_table WHERE id_mobil='$id_mobil'";
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='ListCar-Panca.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id');window.location='ListCar-Panca.php';</script>";
  }         
  ?>
<!doctype html>
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="Home-Panca.php">Home</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="ListCar-Panca.php">My Car</a>
                </li>
