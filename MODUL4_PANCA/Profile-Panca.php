...
// if(isset($_SESSION['login'])) {
    ...
    if(isset($_COOKIE['login'])) {
        if($_COOKIE['login']) {
            ...
            $id = $_COOKIE['user_id'];
            $sql = "SELECT * FROM users_Panca WHERE id='$id'";
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="position-relative" style="margin-left: 50%; margin-top: 10px;">
                    ...
                    if(isset($_SESSION['login'])) {
                        ?>
                        <a href="qwe/logout.php" class="text text-white">Logout</a>
                        <?php
                    }
                ?>
                </div>
    ...
    <div class="footer">
        <div class="row">
            <div class="col" style="text-align: center; margin-top: 10px;">
                <span class="text text-white">&copy;2022 Copyright: <a href="#" data-bs-toggle="modal" data-bs-target="#nimModal">Noor Panca Maulana 1202204283</a></span>
            </div>
        </div>
    </div>
