      ...
      <ul class="nav justify-content-center">
        ...
        <li class="nav-item ">
          ...
          <a class="nav-link active text-light" href="Panca_Booking.php">
            ...
            <p class="bg-secondary" style="text-align:center;color:black">
            <b>
            ...
            <div class="card mb-3">
                ...
                <div class="col-md-5">
                    <from action="mybooking.php" method="GET">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="Name" value="Panca_1202204283" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type= "duration" class= "from-control" name="duration" value="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type= "phonenumber" class= "form-control" name="phonenumber" value="Please Enter Your Phone Number">

                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Apakah anda Membutuhkan Supir ?</label>
                            <div>
                                <input type="checkbox" name="supir" value="ya" id="radio-ya" />
                                <label for="radio-ya">Health protocol /Rp50.000</label>
                                <br>
                                <input type="checkbox" name="supir" value="ya" id="radio-ya" />
                                <label for="radio-ya">Driver /Rp150.000</label>
                                <br>
                                <input type="checkbox" name="supir" value="ya" id="radio-ya" />
                                <label for="radio-ya">Full filled /Rp200.000</label>
                                <br>
                        ...
                        <form action="mybooking.php" method="POST">
                          ...
                          <a class="nav-link active text-light" href="Panca_BookDetail.php">
                                BOOK
                            </a>
                        </button>
                        </form>
                ...
                <br>
                <footer style="text-align: left;color:red">
    <b>
        (Panca_1202204283)
    </b>
</footer>
